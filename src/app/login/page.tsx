...
import { isDemoMode, getDemoCredentials } from '@/lib/demo'
...
export default function LoginPage() {
  ...
  const handleDemoLogin = async () => {
    ...
    try {
      ...
      // Sign in with the demo credentials from local config
      const creds = getDemoCredentials()
      if (!creds) throw new Error('Demo mode is not enabled')
